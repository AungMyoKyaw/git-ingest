      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {installMethods.map((method, index) => (
            <Card key={method.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <div className="flex items-center gap-2 bg-muted/50 rounded-lg p-3">
                  ...
                  <code className="text-sm font-mono flex-1 truncate">{method.command}</code>
                  <Button
                    variant="ghost"
                    size="sm"
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-center mb-8">Common Usage Examples</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {usageExamples.map((example, index) => (
              <Card key={example.title} className="group hover:shadow-md transition-all duration-300">
                ...
                <CardContent>
                  <div className="flex items-center gap-2 bg-muted/30 rounded-md p-2">
                    <Terminal className="w-4 h-4 text-muted-foreground flex-shrink-0" />
                    <code className="text-sm font-mono flex-1 truncate">{example.command}</code>
                    <Button
                      variant="ghost"
                      size="sm"
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4 bg-primary/5 border border-primary/20 rounded-lg p-6">
            <div className="text-left">
              ...
              <p className="text-sm text-muted-foreground">Install Git-Ingest and analyze your first project in under a minute.</p>
            </div>
            <Button
              size="lg"
